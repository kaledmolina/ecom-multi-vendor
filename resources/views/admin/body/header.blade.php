	...
	@endphp		
            <div class="user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="bx bx-user"></i><span>Mi Perfil</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item" href="{{ route('admin.logout') }}"><i class='bx bx-log-out-circle'></i><span>Cerrar</span></a>
                    </li>
                </ul>
            </div>
        </nav>
